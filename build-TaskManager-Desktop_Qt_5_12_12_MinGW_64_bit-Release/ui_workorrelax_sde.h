...
""));
        ...
        gridLayoutWidget->setGeometry(QRect(80, 580, 311, 42));
        gridLayout = new QGridLayout(gridLayoutWidget);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        pushButton_pause = new QPushButton(gridLayoutWidget);
        pushButton_pause->setObjectName(QString::fromUtf8("pushButton_pause"));
        pushButton_pause->setMinimumSize(QSize(150, 40));
        pushButton_pause->setMaximumSize(QSize(150, 40));
...
"}"));
        ...
        pushButton_stop->setMinimumSize(QSize(150, 40));
        pushButton_stop->setMaximumSize(QSize(150, 40));
...
"}"));
        ...
        label_pp->setStyleSheet(QString::fromUtf8(""));
