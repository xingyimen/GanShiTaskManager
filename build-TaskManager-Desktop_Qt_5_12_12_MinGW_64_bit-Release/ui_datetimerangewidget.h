...
public:
    ...
    void setupUi(QWidget *DateTimeRangeWidget)
    {
        ...
        label_endtime->setGeometry(QRect(10, 60, 81, 40));
        ...
        label_text->setGeometry(QRect(120, 20, 341, 81));
