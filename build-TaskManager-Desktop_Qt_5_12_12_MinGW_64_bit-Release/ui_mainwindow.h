...
public:
    ...
    QGraphicsView *SchegraphicsView;
    QWidget *workflow;
    QLabel *label_2;
...
"}\n"
""));
        SchegraphicsView = new QGraphicsView(schedule);
        SchegraphicsView->setObjectName(QString::fromUtf8("SchegraphicsView"));
        SchegraphicsView->setGeometry(QRect(0, 50, 480, 690));
        SchegraphicsView->setMinimumSize(QSize(480, 690));
        SchegraphicsView->setMaximumSize(QSize(480, 690));
        SchegraphicsView->setToolTipDuration(-1);
        SchegraphicsView->setStyleSheet(QString::fromUtf8("QGraphicsView{\n"
"border:0px solid white;\n"
"background-color : rgb(244, 244, 244);\n"
"}"));
        SchegraphicsView->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        SchegraphicsView->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        SchegraphicsView->setAlignment(Qt::AlignHCenter|Qt::AlignTop);
        SchegraphicsView->setDragMode(QGraphicsView::ScrollHandDrag);
